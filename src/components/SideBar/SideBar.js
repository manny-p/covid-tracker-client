...
function SideBar(props) {
  ...
  const country = props.countryObject.country ? (
    <h3>{props.countryObject.country}</h3>
  ) : (
    'Please Search Your Country'
  )
  ...
  return (
    <div className={classes.SideBar}>
      ...
      <div className={classes.Section2}>
        ...
        <Modal onClick={countriesList} className={classes.Button}>
          Save
        </Modal>
        <div className={classes.Container}>
          ...
          <div className={classes.Section2Stat}>
            <NumberFormat
              value={props.countryObject.cases}
              displayType={'text'}
              thousandSeparator={true}
            />
            <NumberFormat
              value={props.countryObject.deaths}
              displayType={'text'}
              thousandSeparator={true}
            />
            <NumberFormat
              value={props.countryObject.recovered}
              displayType={'text'}
              thousandSeparator={true}
            />
          </div>
